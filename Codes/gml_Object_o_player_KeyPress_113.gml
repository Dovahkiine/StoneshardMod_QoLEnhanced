...
if (!is_undefined(_closest_x) && !is_undefined(_closest_y))
{
    ...
    _scr_auto_move_to_transition(_closest_x, _closest_y);
}
else
{
    ...
    _scr_auto_move_to_transition(_target_x, _target_y);
}
