function scr_hunger_percent_limits()
{
...
function scr_hungercheck()
{
    var _percent_limits = scr_hunger_percent_limits();
    scr_check_condition("Hunger", o_db_hunger1, o_db_hunger2, o_db_hunger3, o_db_hunger, _percent_limits[0], _percent_limits[1], _percent_limits[2]);
}
