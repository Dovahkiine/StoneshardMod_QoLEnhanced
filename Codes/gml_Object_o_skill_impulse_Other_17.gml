...
{
    var _aoe_range = clamp(2 + floor(((owner.WIL * 2) + owner.Magic_Power + (owner.Electromantic_Power * 2)) / 100), 2, 5);
    ...
    var _debuff_damage = math_round((1.8 + owner.WIL * 0.02 + owner.Electromantic_Power * 0.02) * (100 + owner.Electromantic_Power) / 80);
